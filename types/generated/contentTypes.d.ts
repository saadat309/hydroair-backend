...
export interface ApiChatbotContextChatbotContext
  extends Struct.SingleTypeSchema {
  collectionName: 'chatbot_contexts';
  info: {
    description: 'Admin managed chatbot context';
    displayName: 'Chatbot Context';
    pluralName: 'chatbot-contexts';
    singularName: 'chatbot-context';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    addFeatures: Schema.Attribute.Component<
    ...
    FAQs: Schema.Attribute.Component<'products.faq', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    international_currency: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSubscriptionListSubscriptionList
  extends Struct.CollectionTypeSchema {
  collectionName: 'subscription_lists';
  info: {
    displayName: 'Subscription List';
    pluralName: 'subscription-lists';
    singularName: 'subscription-list';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::subscription-list.subscription-list': ApiSubscriptionListSubscriptionList;
